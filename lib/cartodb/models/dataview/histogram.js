...
var dateBinsQueryTpl = dot.template([
    ...
    '               SELECT GENERATE_SERIES(start_date::timestamptz, end_date::timestamptz, \'3 month\'::interval)',
    '               {{??}}',
    '               SELECT GENERATE_SERIES(',
    '                   start_date::timestamptz,',
    '                   end_date::timestamptz,',
    '                   \'1 {{=it._aggregation}}\'::interval',
    '                )',
    '               {{?}}',
    '           ) AS bins_array',
    '       FROM basics',
...
var dateHistogramQueryTpl = dot.template([
    ...
    '    min(date_part(',
    '       \'epoch\', ',
    '       date_trunc(\'{{=it._aggregation}}\', {{=it._column}}::timestamptz',
