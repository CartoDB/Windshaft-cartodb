...
MapController.prototype.register = function(app) {
    app.get(app.base_url_mapconfig, cors(), tagger('mapview'), userMiddleware,
        this.createGet.bind(this));
    app.post(app.base_url_mapconfig, cors(), tagger('mapview'), userMiddleware,
        this.createPost.bind(this));
    app.get(app.base_url_templated + '/:template_id/jsonp', cors(), tagger(['mapview', 'namedmap']), userMiddleware,
        this.jsonp.bind(this));
    app.post(app.base_url_templated + '/:template_id', cors(), tagger(['mapview', 'namedmap']), userMiddleware,
