...
function setDbCredentialsFromApiKey(context) {
  if (context.auth.apiKeyToken === 'default_public') {
    context.db.user = context.userContext.metadata.dbpublicuser;
    context.db.password = context.userContext.metadata.dbpublicpass;
  } else {
