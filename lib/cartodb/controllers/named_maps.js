...
NamedMapsController.prototype.register = function(app) {
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_17),
        this.prepareContext,
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_3),
