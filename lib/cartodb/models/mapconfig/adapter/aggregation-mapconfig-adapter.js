...
module.exports = class AggregationMapConfigAdapter {
    ...
    getMapConfig (mapConfigAdapterProxy, callback) {
        const { user, requestMapConfig, params } = mapConfigAdapterProxy;
        ...
        this.pgConnection.getConnection(user, (err, connection) => {
            ...
            this._adaptLayers(connection, mapConfig, mapConfigAdapterProxy, callback);
        });
    }
    ...
    _adaptLayers (connection, mapConfig, mapConfigAdapterProxy, callback) {
