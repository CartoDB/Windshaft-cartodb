...
function NamedLayers(templateMaps, pgConnection) {
    this.templateMaps = templateMaps;
    this.pgConnection = pgConnection;
}

module.exports = NamedLayers;

NamedLayers.prototype.getMapConfig = function (user, requestMapConfig, params, context, callback) {
    var self = this;
