...
var MapConfigAdapter = require('./models/mapconfig/map-config-adapter');
var adapter = require('./models/mapconfig/adapter');
...
module.exports = function(serverOptions) {
    ...
    var mapConfigAdapter = new MapConfigAdapter(
        new adapter.NamedLayers(templateMaps, pgConnection),
        new adapter.BufferSize(),
        new adapter.SqlWrap(),
        new adapter.DataviewsWidgets(),
        new adapter.Dataviews(),
        new adapter.Filters(),
        new adapter.DataviewsFilters(),
        new adapter.Datasources(),
        new adapter.Analysis(analysisBackend),
        new adapter.AnalysisLayers(),
        new adapter.TTQuery(),
        new adapter.Overviews(overviewsMetadataApi, filterStatsApi),
        new adapter.TurboCarto()
    );
