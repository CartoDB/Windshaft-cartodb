...
NamedMapsAdminController.prototype.register = function (app) {
    ...
    app.post(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.NAMED_CREATE),
    ...
    app.put(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.NAMED_UPDATE),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.NAMED_GET),
    ...
    app.delete(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.NAMED_DELETE),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.NAMED_LIST),
