...
function NamedMapsController(prepareContext, namedMapProviderCache, tileBackend, previewBackend,
    surrogateKeysCache, tablesExtentApi, metadataBackend, pgConnection) {
...
console.log('staticMap res.locals.db');
    ...
    step(
        ...
        function estimateBoundsIfNoImageOpts(err, imageOpts) {
            ...
            namedMapProvider.getAffectedTablesAndLastUpdatedTime(function(err, affectedTablesAndLastUpdate) {
                ...
                console.log('params.dbparams.dbparams.dbparams.db')
                console.log(params.db)

                self.tablesExtentApi.getBounds(self.pgConnection.getMasterConnection(params.db), affectedTables, function(err, result) {
