...
module.exports = function() {
    ...
    var me = {
        ...
        user_stats_key: "tiler:users:<%= username %>"
    };
     ...
     */
    me.incMapviewCount = function(username, callback) {
        var redisKey = _.template(this.user_stats_key, {username: username});

        this.redisCmd(me.user_metadata_db, 'HINCRBY', [redisKey, 'mapviews', 1], function(err, val) {
          if ( err ) callback(err, null);
