...
MapController.prototype.create = function(req, res, prepareConfigFn, next) {
    ...
    step(
        ...
        function finish(err) {
            ...
            const { layergroup, analysesResults = [] } = res.locals;
...
MapController.prototype.instantiateTemplate = function(req, res, prepareParamsFn, next) {
    ...
    step(
        ...
        function finishTemplateInstantiation(err) {
            ...
            self.addAnalysesMetadata(cdbuser, layergroup, analysesResults);
...
MapController.prototype.afterLayergroupCreateBuilder = function (options = {}) {
    const self = this;
    const { useTemplateHash = false } = options;
    ...
    return function (req, res, callback) {
        step(
            ...
            function augmentLayergroupIdWithTemplateHash (err) {
                assert.ifError(err);
                ...
                self.augmentLayergroupIdWithTemplateHash(req, res, this);
            },
            function (err) {
                assert.ifError(err);
...
MapController.prototype.augmentLayergroupIdWithTemplateHash = function (req, res, callback) {
