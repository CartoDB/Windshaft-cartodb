...
LayergroupController.prototype.register = function(app) {
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.TILE),
        this.prepareContext,
        this.tile.bind(this),
        vectorError()
    );
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ATTRIBUTES),
        this.prepareContext,
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.STATIC),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.DATAVIEW),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.DATAVIEW_SEARCH),
        allowQueryParams(allowedDataviewQueryParams),
        this.prepareContext,
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ANALYSIS),
        this.prepareContext,
