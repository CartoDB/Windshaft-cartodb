...
LayergroupController.prototype.register = function(app) {
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_8),
        this.prepareContext,
        this.tile.bind(this),
        vectorError()
    );
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_9),
        this.prepareContext,
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_2),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_5),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_6),
        allowQueryParams(allowedDataviewQueryParams),
        this.prepareContext,
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimitMiddleware(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_7),
        this.prepareContext,
