...
module.exports = function(serverOptions) {
    ...
    var metadataBackend = cartodbRedis({pool: redisPool, apiName: 'maps'});
    var pgConnection = new PgConnection();
    ...
    var mapConfigAdapter = new MapConfigAdapter(
        ...
        new MapConfigOverviewsAdapter(overviewsMetadataApi, filterStatsApi, pgConnection),
    ...
    new controller.NamedMapsAdmin({authApi, templateMaps, metadataBackend}).register(app);

    new controller.Analyses({prepareContext, pgConnection, metadataBackend}).register(app);
