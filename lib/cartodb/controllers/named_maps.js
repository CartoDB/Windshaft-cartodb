...
NamedMapsController.prototype.register = function(app) {
    app.get(app.base_url_templated +
        '/:template_id/:layer/:z/:x/:y.(:format)', cors(), tagger(['namedmap', 'tile']), userMiddleware,
        this.tile.bind(this));

    app.get(app.base_url_mapconfig +
        '/static/named/:template_id/:width/:height.:format', cors(), tagger(['namedmap', 'static']), userMiddleware,
