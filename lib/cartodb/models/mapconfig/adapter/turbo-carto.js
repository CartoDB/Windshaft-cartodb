...
TurboCartoAdapter.prototype.getMapConfig = function (user, requestMapConfig, params, context, callback) {
    ...
    layers.forEach(function(layer, index) {
        ...
        parseCartoQueue.defer(self._parseCartoCss.bind(self), datasourceRegistry, layer, index, layerId);
    });
...
TurboCartoAdapter.prototype._parseCartoCss = function (datasourceRegistry, layer, layerIndex, layerId, callback) {
