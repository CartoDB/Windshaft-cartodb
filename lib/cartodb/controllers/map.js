...
MapController.prototype.createLayergroup = function () {
    return function createLayergroupMiddleware (req, res, next) {
        ...
        const options = createOptionsForMapConfigProvider(res.locals);
console.log('createLayerGroup'); //TODO remove
console.log(options); //TODO remove
        const mapconfigProvider =
            new CreateLayergroupMapConfigProvider(mapconfig, user, this.userLimitsApi, options);
...
function createOptionsForMapConfigProvider(context) {
...
MapController.prototype.getAffectedTables = function () {
    return function getAffectedTablesMiddleware (req, res, next) {
        ...
        this.pgConnection.getMasterConnection(dbConfig, (err, connection) => {
            if (err) {
                return next(err);
            }
