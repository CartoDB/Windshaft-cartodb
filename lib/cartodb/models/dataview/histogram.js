...
var binsQueryTpl = dot.template([
    ...
    '  FROM __cdb_basics, iqrange, filtered_source',
    '  LIMIT 1',
    ')'
].join('\n'));
...
var histogramQueryTpl = dot.template([
    ...
    '    count(*) AS freq',
    'FROM filtered_source, __cdb_basics, nulls, __cdb_bins{{?it._isFloatColumn}}, infinities, nans{{?}}',
...
var dateHistogramQueryTpl = dot.template([
    ...
    '    count(*) AS freq',
    'FROM ({{=it._query}}) __cdb_histogram, __cdb_basics, __cdb_bins, nulls',
