...
NamedMapsAdminController.prototype.register = function(app) {
    app.post(app.base_url_templated, cors(), tagger(['namedmap', 'admin']), userMiddleware,
        this.create.bind(this));
    app.put(app.base_url_templated + '/:template_id', cors(), tagger(['namedmap', 'admin']), userMiddleware,
        this.update.bind(this));
    app.get(app.base_url_templated + '/:template_id', cors(), tagger(['namedmap', 'admin']), userMiddleware,
        this.retrieve.bind(this));
    app.delete(app.base_url_templated + '/:template_id', cors(), tagger(['namedmap', 'admin']), userMiddleware,
        this.destroy.bind(this));
    app.get(app.base_url_templated, cors(), tagger(['namedmap', 'admin']), userMiddleware,
        this.list.bind(this));
