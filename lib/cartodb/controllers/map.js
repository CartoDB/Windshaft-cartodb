...
function getDbMasterConfig(context) {
    return {
...
MapController.prototype.getAffectedTables = function () {
    return function getAffectedTablesMiddleware (req, res, next) {
        ...
        const dbConfig = getDbMasterConfig(res.locals);

        this.pgConnection.getConnection(dbConfig, (err, connection) => {
            if (err) {
                return next(err);
            }
...
MapController.prototype.setLayerStats = function () {
    return function setLayerStatsMiddleware(req, res, next) {
        ...
        this.pgConnection.getConnection(getDbMasterConfig(res.locals), (err, connection) => {
            if (err) {
                return next(err);
            }
