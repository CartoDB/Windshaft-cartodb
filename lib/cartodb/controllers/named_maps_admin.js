...
NamedMapsAdminController.prototype.register = function (app) {
    ...
    app.put(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_14),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_12),
    ...
    app.delete(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_15),
    ...
    app.get(
        ...
        cors(),
        userMiddleware,
        rateLimit(this.metadataBackend, RATE_LIMIT_ENDPOINTS_GROUPS.ENDPOINT_10),
