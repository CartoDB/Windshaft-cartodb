...
--
-- TOC entry 5623 (class 2620 OID 13870248)
-- Name: test_quota; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER test_quota BEFORE INSERT OR UPDATE ON analysis_rent_listings FOR EACH STATEMENT EXECUTE PROCEDURE cartodb.cdb_checkquota('0.1', '-1', 'public');


--
-- TOC entry 5627 (class 2620 OID 13870265)
-- Name: test_quota; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER test_quota BEFORE INSERT OR UPDATE ON analysis_banks FOR EACH STATEMENT EXECUTE PROCEDURE cartodb.cdb_checkquota('0.1', '-1', 'public');


--
-- TOC entry 5624 (class 2620 OID 13870249)
-- Name: test_quota_per_row; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER test_quota_per_row BEFORE INSERT OR UPDATE ON analysis_rent_listings FOR EACH ROW EXECUTE PROCEDURE cartodb.cdb_checkquota('0.001', '-1', 'public');


--
-- TOC entry 5628 (class 2620 OID 13870266)
-- Name: test_quota_per_row; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER test_quota_per_row BEFORE INSERT OR UPDATE ON analysis_banks FOR EACH ROW EXECUTE PROCEDURE cartodb.cdb_checkquota('0.001', '-1', 'public');


--
-- TOC entry 5621 (class 2620 OID 13870246)
-- Name: track_updates; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER track_updates AFTER INSERT OR DELETE OR UPDATE OR TRUNCATE ON analysis_rent_listings FOR EACH STATEMENT EXECUTE PROCEDURE cartodb.cdb_tablemetadata_trigger();


--
-- TOC entry 5625 (class 2620 OID 13870263)
-- Name: track_updates; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER track_updates AFTER INSERT OR DELETE OR UPDATE OR TRUNCATE ON analysis_banks FOR EACH STATEMENT EXECUTE PROCEDURE cartodb.cdb_tablemetadata_trigger();


--
-- TOC entry 5622 (class 2620 OID 13870247)
-- Name: update_the_geom_webmercator_trigger; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER update_the_geom_webmercator_trigger BEFORE INSERT OR UPDATE OF the_geom ON analysis_rent_listings FOR EACH ROW EXECUTE PROCEDURE cartodb._cdb_update_the_geom_webmercator();


--
-- TOC entry 5626 (class 2620 OID 13870264)
-- Name: update_the_geom_webmercator_trigger; Type: TRIGGER; Schema: public; Owner: development_cartodb_user_359a4d9f-a063-4130-9674-799e90960886
--

CREATE TRIGGER update_the_geom_webmercator_trigger BEFORE INSERT OR UPDATE OF the_geom ON analysis_banks FOR EACH ROW EXECUTE PROCEDURE cartodb._cdb_update_the_geom_webmercator();
