...
NamedMapMapConfigProvider.prototype.getMapConfig = function(callback) {
    ...
    step(
        ...
        function cacheAndReturnMapConfig(err, renderLimits) {
            ...
            // console.log('rendererParams cacheAndReturnMapConfig');
            // console.log(rendererParams);

            return callback(self.err, self.mapConfig, createOptionsForWindshaft(rendererParams), self.context);
        }
    );
};
