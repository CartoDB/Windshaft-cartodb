...
module.exports = function createServer (serverOptions) {
    ...
    //Overviews deprecation
    if (global.environment.enabledFeatures.useOverviewsTables === undefined) {
        global.environment.enabledFeatures.useOverviewsTables = false; //TODO should be true before merging into master
    }

    if (global.environment.enabledFeatures.adaptMapConfigWithOverviewsTables === undefined) {
        global.environment.enabledFeatures.adaptMapConfigWithOverviewsTables = false;  //TODO should be true before merging into master
    }
