...
var tagger = require('../middleware/request-tagger');
...
LayergroupController.prototype.register = function(app) {
    app.get(app.base_url_mapconfig +
        '/:token/:z/:x/:y@:scale_factor?x.:format', cors(), tagger('tile'), userMiddleware,
        this.tile.bind(this));

    app.get(app.base_url_mapconfig +
        '/:token/:z/:x/:y.:format', cors(), tagger('tile'), userMiddleware,
        this.tile.bind(this));

    app.get(app.base_url_mapconfig +
        '/:token/:layer/:z/:x/:y.(:format)', cors(), tagger('tile'), userMiddleware,
        this.layer.bind(this));

    app.get(app.base_url_mapconfig +
        '/:token/:layer/attributes/:fid', cors(), tagger('attributes'), userMiddleware,
        this.attributes.bind(this));

    app.get(app.base_url_mapconfig +
        '/static/center/:token/:z/:lat/:lng/:width/:height.:format', cors(), tagger('static'), userMiddleware,
        this.center.bind(this));

    app.get(app.base_url_mapconfig +
        '/static/bbox/:token/:west,:south,:east,:north/:width/:height.:format',
        cors(), tagger('static'), userMiddleware,
        this.bbox.bind(this));

    // Undocumented/non-supported API endpoint methods.
    // Use at your own peril.
    app.get(app.base_url_mapconfig +
            '/:token/dataview/:dataviewName', cors(), tagger('dataview'), userMiddleware,
        this.dataview.bind(this));
    app.get(app.base_url_mapconfig +
            '/:token/:layer/widget/:dataviewName', cors(), tagger('dataview'), userMiddleware,
        this.dataview.bind(this));

    app.get(app.base_url_mapconfig +
            '/:token/dataview/:dataviewName/search', cors(), tagger('dataview'), userMiddleware,
        this.dataviewSearch.bind(this));
    app.get(app.base_url_mapconfig +
            '/:token/:layer/widget/:dataviewName/search', cors(), tagger('dataview'), userMiddleware,
        this.dataviewSearch.bind(this));

    app.get(app.base_url_mapconfig +
        '/:token/analysis/node/:nodeId', cors(), tagger('analysis'), userMiddleware,
