...
suite('unified_api', function() {
    ...
    var template_acceptance1 =  {
        ...
        name: 'acceptance1',
        auth: { method: 'open' },
        layergroup:  { // SHOULD BE mapConfig ?
          version: '1.0.0',
          layers: [
             { options: {
    ...
    test("can update template", function(done) {
      ...
      Step(
        ...
        function putMisnamedTemplate(err, res)
        {
          ...
          var put_request = {
              url: '/maps/named/' + tpl_id + '/?api_key=1234',
              method: 'PUT',
              headers: {host: 'localhost', 'Content-Type': 'application/json' },
              data: JSON.stringify(template_acceptance1)
          }
        ...
        function putUnexistentTemplate(err, res)
        {
          ...
          var put_request = {
              url: '/maps/named/unexistent/?api_key=1234',
              method: 'PUT',
              headers: {host: 'localhost', 'Content-Type': 'application/json' },
              data: JSON.stringify(template_acceptance1)
          }
    ...
    test("can instanciate a template by id", function(done) {
      ...
      Step(
        ...
        function instanciateAuth(err, res)
        {
          ...
          var post_request = {
              url: '/maps/named/' + tpl_id + '?auth_token=valid2',
              method: 'POST',
              headers: {host: 'localhost', 'Content-Type': 'application/json' },
              data: JSON.stringify(template_params)
          }
        ...
        function fetchTileNoAuth(err, res) {
          ...
          var get_request = {
              url: '/maps/' + layergroupid + ':cb0/0/0/0.png',
              method: 'GET',
              headers: {host: 'localhost' },
              encoding: 'binary'
          }
        ...
        function fetchTileAuth(err, res) {
          ...
          var get_request = {
              url: '/maps/' + layergroupid + '/0/0/0.png?auth_token=valid1',
              method: 'GET',
              headers: {host: 'localhost' },
              encoding: 'binary'
          }
    ...
    test("can instanciate a template using jsonp", function(done) {
      ...
      Step(
        ...
        function instanciateNoAuth(err, res)
        {
          ...
          tpl_id = parsed.template_id;
          var post_request = {
              url: '/maps/named/' + tpl_id + "/jsonp?callback=test",
              method: 'GET',
              headers: {host: 'localhost' }
          }
          var next = this;
    ...
    test("can instanciate a template using jsonp with params", function(done) {
      ...
      Step(
        ...
        function instanciateNoAuth(err, res)
        {
          ...
          tpl_id = parsed.template_id;
          var post_request = {
              url: '/maps/named/' + tpl_id + "/jsonp?callback=test%config=" + JSON.stringify('{color:blue}'),
              method: 'GET',
              headers: {host: 'localhost' }
          }
          var next = this;
    ...
    test("template instantiation raises mapviews counter", function(done) {
      ...
      Step(
        ...
        function deleteTemplate(err)
        {
          if ( err ) throw err;
          var del_request = {
              url: '/maps/named/' + template_id + '?api_key=1234', 
              method: 'DELETE',
              headers: {host: 'localhost'}
          }
          var next = this;
