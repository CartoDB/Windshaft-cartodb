...
function LayergroupController(authApi, pgConnection, mapStore, tileBackend, previewBackend, attributesBackend,
                          listBackend, surrogateKeysCache, userLimitsApi, queryTablesApi, layergroupAffectedTables) {
...
LayergroupController.prototype.register = function(app) {
    ...
    app.get(app.base_url_mapconfig +
        '/:token/list/:listName', cors(), userMiddleware,
        this.list.bind(this));
...
LayergroupController.prototype.list = function(req, res) {
    ...
    step(
        ...
        function retrieveList(err) {
            ...
            self.listBackend.getList(mapConfigProvider, req.params, this);
        },
