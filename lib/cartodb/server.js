...
module.exports = function(serverOptions) {
    ...
    var redisPool = makeRedisPool(serverOptions.redis);
    ...
    serverOptions.grainstore = serverOptions.grainstore || {};
    ...
    serverOptions.renderer = serverOptions.renderer || {};
    ...
    var rendererFactory = new windshaft.renderer.Factory({
        ...
        mapnik: {
            ...
            mapnik: serverOptions.renderer.mapnik || serverOptions.mapnik
        },
