...
var histogramQueryTpl = dot.template([
    ...
    '      THEN 0',
    '      ELSE GREATEST(1, LEAST(WIDTH_BUCKET({{=it._column}}, min_val, max_val, __cdb_bins_number), __cdb_bins_number)) - 1',
    '    END AS bin,',
    ...
    'GROUP BY bin, __cdb_bins_number, bin_width, __cdb_nulls_count,',
...
var dateHistogramQueryTpl = dot.template([
    ...
    'GROUP BY bin, __cdb_bins_number, bin_width, __cdb_nulls_count, __cdb_avg_val, __cdb_start_date',
    'ORDER BY bin'
].join('\n'));
