...
NamedMapsController.prototype.register = function(app) {
    app.get(app.base_url_templated +
        '/:template_id/:layer/:z/:x/:y@:scale_factor?x.:format', cors(), userMiddleware,
        this.tile.bind(this));
    ...
    app.get(app.base_url_mapconfig +
        '/static/named/:template_id/:width/:height@:scale_factor?x.:format', cors(), userMiddleware,
        ...
        function getImage(err, imageOpts) {
            ...
            if (!_.isUndefined(imageOpts.zoom) && imageOpts.center) {
                self.previewBackend.getImageByZoomAndCenter(
                    namedMapProvider, format, width, height, imageOpts.zoom, imageOpts.center, options, this);
            } else {
                self.previewBackend.getImageByBounds(
                    namedMapProvider, format, width, height, imageOpts.bounds, options, this);
            }
        },
